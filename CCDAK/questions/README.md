...
> Về [Kế hoạch tổng](../CCDAK-STUDY-PLAN.md) · [Tuần 10 — tuần chốt](../study-plan/week-10/README.md)

## Quy ước đặt tên

`CCDAK-NNNN.md` với hậu tố 4 chữ số, đánh số tăng dần theo thứ tự bạn viết: `CCDAK-0001.md`, `CCDAK-0002.md`…
