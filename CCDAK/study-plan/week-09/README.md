...
>
> **Điều hướng:** [⬅️ Tuần 8](../week-08/README.md) · [🏠 Kế hoạch tổng](../../CCDAK-STUDY-PLAN.md) · [Tuần 10 ➡️](../week-10/README.md)
...
4. **Sổ câu sai**: mỗi câu sai/phân vân → ghi đề, đáp án đúng, **lý do mình sai** (không biết / đọc nhầm / nhớ số cũ / bẫy từ ngữ), map về Tuần nào. Viết file phân tích theo format `aws-saa-c03-analysis-format.md` vào `CCDAK/questions/` cho ≥ 10 câu đáng nhớ nhất.
