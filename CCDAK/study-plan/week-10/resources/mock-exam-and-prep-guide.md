...
> Về [file học Tuần 10](../README.md) · [Kế hoạch tổng](../../../CCDAK-STUDY-PLAN.md)
...
4. **Review 100% câu sai** trong cùng ngày, mỗi câu đáng nhớ viết một file phân tích 6 mục trong [`CCDAK/questions/`](../../../questions/README.md).
