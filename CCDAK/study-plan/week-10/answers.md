...
| --- | --- | --- |
| **≥ 80%** (24+/30) | Đạt ngưỡng cá nhân. | Review 100% câu sai, viết file phân tích 6 mục trong `CCDAK/questions/`. Làm tiếp full mock **60 câu / 90 phút** từ một bộ practice khác. Đủ **3 bộ khác nhau ≥ 80%** thì đặt lịch thi. |
