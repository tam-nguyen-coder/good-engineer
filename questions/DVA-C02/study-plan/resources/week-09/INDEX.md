...
> Crawl từ tài liệu AWS chính thức (`CloudWatch` / `X-Ray` / `CloudTrail` / `EventBridge` / `Lambda` metrics). Về [file học Tuần 9](../../week-09.md) · [Kế hoạch tổng](../../../DVA-C02-STUDY-PLAN.md)
