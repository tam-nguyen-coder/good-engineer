...
>
> **Điều hướng:** [⬅️ Tuần 4](week-04.md) · [🏠 Kế hoạch tổng](../DVA-C02-STUDY-PLAN.md) · [Tuần 6 ➡️](week-06.md)
...
- **Standard vs FIFO:**
  ...
  - `FIFO`: **exactly-once processing**, **giữ đúng thứ tự**; bắt buộc `MessageGroupId` (phân luồng thứ tự) + `MessageDeduplicationId` (chống trùng); dedup window **5 phút**; throughput **300 msg/s** (tới **3000** khi batching).
...
| `SQS FIFO` throughput | **300 msg/s** (tới **3000** khi batching); dedup window **5 phút** |
