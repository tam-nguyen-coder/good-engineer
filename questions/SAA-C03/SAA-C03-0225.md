...
- *Lưu ý:* Nếu thay Redshift bằng S3 (Firehose → S3), phương án này sẽ trở thành phương án tối ưu nhất (vượt trội hơn đáp án A). Firehose hỗ trợ ghi trực tiếp vào S3 một cách serverless mà không cần cấu hình consumer phức tạp như Kinesis Data Streams, kết hợp với Athena để phân tích SQL với operational overhead thấp nhất.
